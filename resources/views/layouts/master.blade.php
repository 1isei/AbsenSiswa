        ...
        <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/">Absensi  <span>Siswa</span></a>
                </div>
            </div><!-- /.container-fluid -->
        </nav>
                ...
                <li class="parent "><a data-toggle="collapse" href="#sub-item-1">
                    ...
                    <ul class="children collapse" id="sub-item-1">
                        <li><a class="" href="{{ url('/admin/kelas')}}">
                            ...
                            <li><a class="" href="{{ url('/admin/jurusan')}}">
                                <span class="fa fa-angle-right">&nbsp;</span> Jurusan <span class="label label-info">{{App\Jurusan::all()->count()}}</span>
                                </a></li>
